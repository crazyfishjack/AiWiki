...
| exa | 1.00 | Automatic Ontology-Based Model Evolution for Learning Changes in Dynamic Environments | https://www.mdpi.com/2076-3417/11/22/10770 |
...
| exa | 1.00 | AIP: A Graph Representation for Learning and Governing Agent Skills | https://arxiv.org/html/2606.04781 |
...
4. [Apollo:  Modular and Distributed Runtime System for Serverless Function Compositions on Cloud, Edge, and IoT Resources](https://dl.acm.org/doi/10.1145/3452413.3464793)
   ...
   - 保留原因：学术论文
   - 后续处理：进入精读
5. [Building Knowledge Graph in Spark Without SPARQL | Springer Nature Link](https://link.springer.com/chapter/10.1007/978-3-030-59028-4_9)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
6. [OntoKG: Ontology-Oriented Knowledge Graph Construction with Intrinsic-Relational Routing](https://www.arxiv.org/pdf/2604.02618)
   ...
   - 保留原因：学术论文
   - 后续处理：进入精读
7. [Automatic Ontology-Based Model Evolution for Learning Changes in Dynamic Environments](https://www.mdpi.com/2076-3417/11/22/10770)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：B
   - 入库映射：`source-quality: high`
   - 保留原因：Exa 学术/语义结果，默认保留但进入来源等级评估
   - 后续处理：进入 rerank
8. [https://arxiv.org/pdf/2304.14975](https://arxiv.org/pdf/2304.14975)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
9. [Chapter 7 Scalable Knowledge Graph Processing Using SANSA](https://link.springer.com/content/pdf/10.1007/978-3-030-53199-7_7.pdf?error=cookies_not_supported&code=04a2db4f-e21c-4708-9dc7-5fed029b2d7a)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
10. [Original software publication SeMi: A SEmantic Modeling machIne to build Knowledge Graphs with graph neural networks](https://www.sciencedirect.com/science/article/pii/S2352711019302626)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
11. [Foundry: a message-oriented, horizontally scalable ETL system for scientific data integration and enhancement](https://pmc.ncbi.nlm.nih.gov/articles/PMC6301337/)
   ...
   - 保留原因：官方文档 / 一手数据
   - 后续处理：进入精读
12. [LLM-Driven Ontology Construction for Enterprise Knowledge Graphs](https://arxiv.org/pdf/2602.01276)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
13. [Generative Ontology: When Structured Knowledge Learns to Create](https://arxiv.org/pdf/2602.05636v1)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
14. [AIP: A Graph Representation for Learning and Governing Agent Skills](https://arxiv.org/html/2606.04781)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
15. [Data Mining and Big Data: 9th International Conference, DMBD 2024, Ho Chi Minh City, Vietnam, December 13–17, 2024, Proceedings, Part II | Springer Nature Link](https://link.springer.com/content/pdf/10.1007/978-981-96-7178-6.pdf)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
11. [Databricks: Artefact Reveals “The Workforce You Won’t Recognize” - EIN Presswire](https://www.einpresswire.com/article/919827936/databricks-artefact-reveals-the-workforce-you-won-t-recognize)
   ...
   - 来源等级：C
   - 剔除原因：score 低于 0.4
12. [The AI gamble of mining companies: Valuations enter a phase of differentiation, and it's hard to turn the tide - WEEX](https://www.weex.com/news/detail/the-ai-gamble-of-mining-companies-valuations-enter-a-phase-of-differentiation-and-its-hard-to-turn-the-tide-fglrejwbf21tu7j8w4so3s9b)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
13. [Argon & Co: Organisations must rethink operating models to unlock AI and ERP success - Consultancy-me.com](https://www.consultancy-me.com/news/amp/13716/argon-co-organisations-must-rethink-operating-models-to-unlock-ai-and-erp-success)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
14. [VivaTech 2026: Bernard Arnault and Jeff Bezos see AI as a driver of responsible innovation - fashionunited.uk](https://fashionunited.uk/news/fairs/vivatech-2026-bernard-arnault-and-jeff-bezos-see-ai-as-a-driver-of-responsible-innovation/2026061988750)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
...
### 来源 4: 万字解读Palantir产品、技术和架构讨论 - 53AI
