...
| exa | 1.00 |  | https://arxiv.org/pdf/2304.14975 |
...
| exa | 1.00 | Apollo:  Modular and Distributed Runtime System for Serverless Function Compositions on Cloud, Edge, and IoT Resources | https://dl.acm.org/doi/10.1145/3452413.3464793 |
...
| exa | 1.00 | Modelling big data platforms as knowledge graphs: the data platform shaper \| Journal of Big Data \| Springer Nature Link | https://link.springer.com/article/10.1186/s40537-025-01094-w |
...
| exa | 1.00 | Language Models Guidance with Multi-Aspect-Cueing: A Case Study for Competitor Analysis | https://arxiv.org/html/2504.02984 |
...
| tavily | 0.55 | AIP, Foundry, and Apollo • Palantir | https://palantir.com/docs/foundry/architecture-center/platforms |
...
1. [Concept-Centric Software Development](https://arxiv.org/html/2304.14975)
   ...
   - 保留原因：学术论文
   - 后续处理：进入精读
2. [https://arxiv.org/pdf/2304.14975](https://arxiv.org/pdf/2304.14975)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
3. [𝖠𝗎𝗍𝗈𝖵𝖾𝗋𝗂𝖿𝗂𝖾𝗋: An Agentic Automated Verification Framework Using Large Language Models](https://arxiv.org/html/2604.02617v1)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
4. [Data Digitization in Manufacturing Factory Using Palantir Foundry Solution](https://www.mdpi.com/2227-9717/12/12/2816)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：B
   - 入库映射：`source-quality: high`
   ...
   - 后续处理：进入 rerank
5. [A Brief Analysis of Palantir Gotham: A Collaborative and Interactive Big Data Visualization Analysis Software Based on Dynamic Ontology | IEEE Conference Publication | IEEE Xplore](https://ieeexplore.ieee.org/document/10808897)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
6. [Data Mining and Big Data: 9th International Conference, DMBD 2024, Ho Chi Minh City, Vietnam, December 13–17, 2024, Proceedings, Part II | Springer Nature Link](https://link.springer.com/content/pdf/10.1007/978-981-96-7178-6.pdf)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
7. [Apollo:  Modular and Distributed Runtime System for Serverless Function Compositions on Cloud, Edge, and IoT Resources](https://dl.acm.org/doi/10.1145/3452413.3464793)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
8. [Foundry: a message-oriented, horizontally scalable ETL system for scientific data integration and enhancement](https://pmc.ncbi.nlm.nih.gov/articles/PMC6301337/)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 一手数据
   - 后续处理：进入精读
9. [Building Knowledge Graph in Spark Without SPARQL | Springer Nature Link](https://link.springer.com/chapter/10.1007/978-3-030-59028-4_9)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
10. [http://arxiv.org/pdf/2504.03652](http://arxiv.org/pdf/2504.03652)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
11. [OntoKG: Ontology-Oriented Knowledge Graph Construction with Intrinsic-Relational Routing](https://www.arxiv.org/pdf/2604.02618)
   ...
   - 保留原因：学术论文
   - 后续处理：进入精读
12. [Modelling big data platforms as knowledge graphs: the data platform shaper | Journal of Big Data | Springer Nature Link](https://link.springer.com/article/10.1186/s40537-025-01094-w)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
13. [Unifying Ontology Construction and Semantic Alignment for Deterministic Enterprise Reasoning at Scale](https://arxiv.org/pdf/2604.09608)
   ...
   - 保留原因：学术论文
   - 后续处理：进入精读
14. [Language Models Guidance with Multi-Aspect-Cueing: A Case Study for Competitor Analysis](https://arxiv.org/html/2504.02984)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
15. [Palantir 核心技术架构深度研究 - Tech Whims | 张晓龙](https://techwhims.com/cn/posts/palantir-core-architecture)
   ...
   - 保留原因：与主题高度相关
   - 后续处理：进入精读
16. [一文全面解析Palantir产品以及其“本体论”：以AI+本体框架整合多源数据，依托4大平台，让Palantir得以发现隐藏在数据背后的关键关联，构建可演进的闭环决策系统，赋能政府与企业两类客户 – 智慧城市行业分析](https://www.smartcity.team/investment/companies/palantir)
   - 工具：tavily
   - 分数：0.73
   - 来源等级：B
   - 入库映射：`source-quality: high`
...
17. [万字解读Palantir产品、技术和架构讨论 - 53AI](https://www.53ai.com/news/Palantir/2025121217384.html)
   ...
   - 保留原因：与主题高度相关
   - 后续处理：进入精读
18. [帕兰泰尔- 维基百科，自由的百科全书](https://zh.wikipedia.org/zh-cn/%E5%B8%95%E8%98%AD%E6%B3%B0%E7%88%BE)
   - 工具：tavily
   - 分数：0.70
   - 来源等级：C
...
20. [[PDF] 相关研究报告北交所研究团队 - i研报](https://file.iyanbao.com/pdf/1f1fc-fd3e408a-98d0-47f5-a93a-a9e7dd6537e9.pdf)
   ...
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
21. [万字解读Palantir产品、技术和架构讨论 - 53AI-AI知识库|企业AI知识库|大模型知识库|前线部署工程师|FDE|AIHub](https://www.53ai.com/news/AISaaS/2025121217384.html)
   - 工具：tavily
   - 分数：0.69
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
22. [Palantir - 全球大数据与AI领域市值最高的公司-产品核心技术 - 53AI](https://www.53ai.com/news/knowledgegraph/2025120478305.html)
   - 工具：tavily
   - 分数：0.67
   - 来源等级：C
   - 入库映射：`source-quality: medium`
...
23. [Palantir 产品体系深度解构：Ontology 驱动下的分层架构与模块- 墨天轮](https://www.modb.pro/db/1930804422725087232)
   ...
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
24. [[PDF] 深度解析Palantir](https://pdf.dfcfw.com/pdf/H3_AP202501221642435170_1.pdf)
   - 工具：tavily
   - 分数：0.66
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
25. [平台概览 - Palantir](https://www.palantir.com/docs/zh/foundry/platform-overview/overview)
   - 工具：tavily
   - 分数：0.60
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
26. [成功转型800亿美元AI领导者，Palantir做对了什么？ - 安全内参 | 决策者的网络安全知识库](https://www.secrss.com/articles/71253?app=1)
   - 工具：tavily
   - 分数：0.58
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
27. [[重磅-万字长文]千亿美金市值美国AI政企服务巨头Palantir产品及商业化全面解析 - 漫思 - 博客园](https://www.cnblogs.com/sexintercourse/p/18566250)
   - 工具：tavily
   - 分数：0.58
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
28. [构建管道• Best practices • 推荐的项目和团队结构 - Palantir](https://www.palantir.com/docs/zh/foundry/building-pipelines/recommended-project-structure)
   - 工具：tavily
   - 分数：0.57
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
29. [Palantir's Ontology, Foundry, Gotham, AIP, and Nvidia collaboration for edge devices | Ayan Das posted on the topic | LinkedIn](https://www.linkedin.com/posts/ayan-das-02982b1b6_ai-infrastructure-and-ontology-activity-7390866430306717696-eEqz)
   - 工具：tavily
   - 分数：0.57
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
30. [AIP, Foundry, and Apollo • Palantir](https://palantir.com/docs/foundry/architecture-center/platforms)
   - 工具：tavily
   - 分数：0.55
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
31. [Palantir Operationalizes Analytics and Data for Actions and Decisions](https://research.isg-one.com/analyst-perspectives/palantir-operationalizes-analytics-and-data-for-actions-and-decisions)
   - 工具：tavily
   - 分数：0.54
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
32. [Documentation • Palantir](https://palantir.com/docs/foundry)
   - 工具：tavily
   - 分数：0.53
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
33. [Ontology搭建 - Palantir](https://www.palantir.com/docs/zh/foundry/ontology/overview)
   - 工具：tavily
   - 分数：0.43
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
34. [Ontology design: Best practices • Palantir](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices)
   - 工具：tavily
   - 分数：0.42
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
7. [How SpaceX’s float could lift the tide for European space tech - PitchBook](https://pitchbook.com/news/articles/how-spacexs-float-could-lift-the-tide-for-european-space-tech)
   ...
   - 来源等级：C
   - 剔除原因：score 低于 0.4
8. [Elastic to Acquire DeductiveAI Startup for $85 Million - Zamin.uz](https://zamin.uz/en/technology/207965-elastic-to-acquire-deductiveai-startup-for-85-million.html)
   - 工具：tavily
   - 分数：0.04
   - 来源等级：C
   - 剔除原因：score 低于 0.4
...
### 来源 5: https://arxiv.org/pdf/2304.14975

- URL: https://arxiv.org/pdf/2304.14975
...
Developers have long recognized the importance of the concepts underlying the systems they build. To date, however, concepts have tended to be only implicit in software design with development being organized instead around more concrete artifacts (such as wireframes and code modules).

Palantir is a software company whose data analytics products are widely used by major corporations. Recently reworked to bring concepts to the fore, Palantir's development practices enable engineers to align products more closely based on shared concepts and evolve concepts in response to user needs.

This paper reports on Palantir's experiences to date and offers advice for other organizations considering adopting a concept-centric approach to software development.
...
Developers have long recognized the importance of the concepts underlying the systems they build. However, concepts have largely been implicit in software design with development organized around more concrete artifacts such as wireframes and code modules.

Palantir uses Foundry software to manage its ontology and runs various business processes internally. The concept inventory was augmented to include concepts and relationships between them. This allowed external resources (design mocks in Figma, prior art search documents in word processors) to reference and be referenced by the concept they illustrated.

---

## Outline of Concept Design Theory

For decades, software engineers have recognized the importance of the concepts that underlie software systems. EOS provides a theory of concept design that emphasizes specificity, familiarity, independence, purposiveness, reuse and valuable nature.

Concept design starts with ideas that can be translated into formal definitions. EOS defines concepts as sets of state machines representing functionality that users experience directly.

---

## Formalizing Concept Representations

Formalizing the representation of concepts involves choosing two properties: a name and description. These properties help distinguish concepts from features and ensure clarity in documentation.

Concepts are categorized into clusters based on their thematic relevance. Examples include Files/Media/Attachments, Data Entry/Tagging etc.

---

## Example Concept

The Clip concept was invented as a way to embed segments of a given resource within another derivative resource while maintaining linkage between source and destination:

![clip](extracted/5183954/images/clips.jpg)
_Figure 7: From top to bottom: an example of TextSnippet, MapSlide and VideoClip._

Inspired by OpenDoc's early work on bookmarks and live previews, Clip aimed to generalize application-specific concepts like TextSnippet, MapSlide and VideoClip across multiple applications.

### Concept Definition

The Clip concept was initially defined as follows:

```
class Clip:
    def __init__(self):
        self.name = "Clip"
        self.description = "Embed segments of a given resource within another derivative resource."
        # Additional properties...
```

### Concept Relationships

The Clip concept was related to existing entities such as List (for list operations) and Folder (for folder operations).

### User Feedback Analysis

Users reported issues with version control semantics for Clip versions. Clarification efforts were initiated following feedback analysis.

---

## Concepts in Action

Concepts evolve over time due to user needs and technological advancements. Overcoming challenges requires gradual adoption through mechanisms such as bootstrapping or plugins for existing tools.

### User Engagement Metrics

| Metric | Value |
| --- | --- |
| Uptake of concept entities | About 250 regular users within our development organization |
| Product Documentation | Organic adoption through internal documentation |
| Product Manager Career Growth | Increased opportunities for promotion |

### Adoption Challenges

Challenges include resistance from product managers who prefer promotions based on technical skills rather than broader impact on products.

---

## Recommendations

To maximize benefits from concept design:

* **Inventory Your Concepts**: Centralized inventory ensures comprehensive coverage.
* **Focus on User Need**: Concepts should address user needs.
* **Record Concept Relationships**: Cluster related concepts.
* **Resist Perfectionism**: Favor inclusion over correctness.
* **Invest in Names**: Choose good names consistently.
* **Focus on Value**: Focus on broad usefulness.
* **Teach Your Organization

### 来源 7: [PDF] 深度解析Palantir
...
### 来源 9: 一文全面解析Palantir产品以及其“本体论”：以AI+本体框架整合多源数据，依托4大平台，让Palantir得以发现隐藏在数据背后的关键关联，构建可演进的闭环决策系统，赋能政府与企业两类客户 – 智慧城市行业分析
...
[Palantir](https://www.palantir.com/) [Documentation](https://www.palantir.com/docs/zh/foundry/)
...
[API 参考 ↗](https://www.palantir.com/docs/foundry/api-reference/)Send feedback
...
- 功能
  ...
  - [数据连接与集成](https://www.palantir.com/docs/zh/foundry/data-integration/overview/)
  - [用例开发](https://www.palantir.com/docs/zh/foundry/app-building/overview/)
  - [分析](https://www.palantir.com/docs/zh/foundry/analytics/overview/)
  - [模型集成](https://www.palantir.com/docs/zh/foundry/model-integration/overview/)
  - [开发运维](https://www.palantir.com/docs/zh/foundry/devops/overview/)
  - [安全](https://www.palantir.com/docs/zh/foundry/security/overview/)
  - [本体](https://www.palantir.com/docs/zh/foundry/ontology/overview/)
  - [管理](https://www.palantir.com/docs/zh/foundry/administration/overview/)
- [入门](https://www.palantir.com/docs/zh/foundry/getting-started/overview/)
- [平台概述](https://www.palantir.com/docs/zh/foundry/platform-overview/overview/)

[平台概述](https://www.palantir.com/docs/zh/foundry/platform-overview/overview/)[平台概览](https://www.palantir.com/docs/zh/foundry/platform-overview/overview/)

注意：以下翻译的准确性尚未经过验证。这是使用 [AIP ↗](https://www.palantir.com/platforms/aip/) 从原始英文文本进行的机器翻译。

# [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%B9%B3%E5%8F%B0%E6%A6%82%E8%A7%88) 平台概览
...
简而言之，Palantir AIP 将生成性AI与运营连接在一起。与 Foundry - Palantir 的数据运营平台 - 以及 Apollo - Palantir 用于自主软件部署的任务控制平台 - 一起，AIP 是一个 _AI 网格_ 的一部分，能够提供全套的AI驱动产品，从 LLM 驱动的网络应用到使用视觉语言模型的移动应用，再到嵌入本地化 AI 的边缘应用。我们将这整套能力、功能和工具称为 _Palantir 平台_。

尽管实现和扩大 Palantir 平台的运营影响力有许多因素 —— 包括 [AIP 训练营 ↗](https://www.palantir.com/platforms/aip/bootcamp/)，客户可以在短短几小时内通过 AI 实现成果 —— 关键的差异化因素是围绕 Palantir [Ontology](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#the-ontology) 的软件架构。

## [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#ontology) Ontology

Ontology 旨在表示企业中的 _决策_，而不仅仅是数据。世界上的每个组织都面临如何在瞬息万变的内部和外部条件下执行最佳决策的挑战，通常是实时的。
...
## [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%86%B3%E7%AD%96%E7%BB%84%E4%BB%B6) 决策组件
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%95%B0%E6%8D%AE) 数据

Ontology 将数据作为 [对象和链接](https://www.palantir.com/docs/foundry/ontology/overview/#object-and-link-types) 集成，以使运营的现实世界复杂性对人类和AI都可理解。这解锁了构建 _人类+AI协作_ 工作流的能力。

Ontology 本地支持多种数据类型以及一些扩展基元，例如用于解锁非结构化数据的 [语义搜索](https://www.palantir.com/docs/foundry/functions/overview-semantic-search/)、用于处理图像和视频的 [媒体引用](https://www.palantir.com/docs/foundry/data-integration/media-sets/#ontologize-media-using-media-references) 和用于在数据中嵌入额外约束和上下文的 [值类型](https://www.palantir.com/docs/foundry/object-link-types/value-types-overview/)。这些是 AI 工作流开发的数据构建块，在下面的 [逻辑](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#logic) 和 [操作](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#actions) 部分中有更详细的描述。

此数据模型为探索结构化、非结构化、地理空间、时间序列、模拟和其他数据模式的开箱即用应用程序提供支持。这些基础工具与上下文感知的 [AIP Assist](https://www.palantir.com/docs/foundry/assist/overview/) 相结合，大大缩短了在平台中探索和分析数据的时间。

除了应用程序构建和分析外，在 Ontology 中建模数据会自动创建一个强大的 API 网关和 Ontology 软件开发工具包（OSDK），作为企业内连接性的“运营总线”。

#### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%95%B0%E6%8D%AE%E8%BF%9E%E6%8E%A5) 数据连接

数据很少以干净、正确和形状良好的格式提供，以准确和可靠地向决策者展示事实。为此，Palantir 平台提供了一个可扩展的、多模式的数据连接和集成框架，能够开箱即用地与企业数据系统协作。

[Pipeline Builder](https://www.palantir.com/docs/foundry/pipeline-builder/overview/) 将 [LLM数据变换](https://www.palantir.com/docs/foundry/pipeline-builder/pipeline-builder-llm/) 的能力放入一个点击即用的包中，使使用最新的 LLMs 来支持基于管道的变换（如分类、情感分析、摘要、实体提取或翻译）变得简单。这为在 Ontology 中自动创建“提案”供操作员审查和批准奠定了基础，无需一直运行实时模型请求的滞后。（注意，正如在下面的 [逻辑](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#logic) 部分中讨论的，这两种与模型交互的方法是高度互补的。）

此外， [Pipeline Builder](https://www.palantir.com/docs/foundry/pipeline-builder/overview/) 和 [Code Repositories](https://www.palantir.com/docs/foundry/code-repositories/overview/) 中的 [AIP Assist](https://www.palantir.com/docs/foundry/assist/overview/) 通过一个具有深度集成的 AI 合作伙伴加速数据工程，该合作伙伴不仅能访问 Palantir 文档和通用代码片段存储库，还可以为下一步操作或相关教程提供建议。

### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E9%80%BB%E8%BE%91) 逻辑

如果数据定义了我们决策的背景，逻辑则封装了丰富此背景的推理和分析，使人类+AI 团队能够做出更好的决策。这可以以模型输出和可视化的形式提供额外的上下文，呈现在运营应用中，或直接融入操作的机制中。

基于这一广泛定义，定义和执行逻辑的能力贯穿于整个平台；例如，我们可以考虑 [模型](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#models)、 [业务逻辑](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#business-logic) 和 [模板化分析和报告](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#templated-analyses-and-reports)。

#### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%A8%A1%E5%9E%8B) 模型

_生成性AI、LLMs、预测、优化器等_

像 LLMs 或预测这样的模型接受参数并提供输出，以作为当前决策的背景。在数据科学家熟悉的循环中，这些模型通常经历训练和优化的迭代过程；然而，将这些模型用作生产中的运营工作流可能是一个挑战。Palantir 的建模能力可以促进模型的运营部署。

在 Palantir 平台中，模型的完整生命周期被捕获为 [建模目标](https://www.palantir.com/docs/foundry/model-integration/objectives/)，而模型本身的逻辑被抽象为 [模型适配器](https://www.palantir.com/docs/foundry/integrate-models/integrate-overview/)。这种方法意味着无论您是 [在平台中训练](https://www.palantir.com/docs/foundry/integrate-models/model-asset-code-repositories/)、 [自行携带容器](https://www.palantir.com/docs/foundry/integrate-models/container-overview/) 还是 [上传预训练模型](https://www.palantir.com/docs/foundry/integrate-models/model-asset-files/)，各种模型都可以通过 [函数](https://www.palantir.com/docs/foundry/functions/functions-on-models/) 绑定到 Ontology 中，以便在运营应用中进行实时交互，或者被配置为 [批量部署](https://www.palantir.com/docs/foundry/manage-models/set-up-batch/) 并计划在数据管道中执行。

特别是对于生成性AI，Palantir 的语言模型服务提供了一个统一的界面用于多模式交互，同时抽象了特定模型和提供商的实现细节，使得在商业可用的 LLMs 领域中进行开发变得简单。为了进一步改进结果，Palantir 的 [评估](https://www.palantir.com/docs/foundry/logic/evaluations-overview/) 工具可以让您在时间和模型之间对 LLM 的性能进行基准测试，以监控漂移并自信地进行更改。

#### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E4%B8%9A%E5%8A%A1%E9%80%BB%E8%BE%91) 业务逻辑

_业务规则、流程映射、语义搜索_

当建模方法采用自下而上的数据训练方法时，业务逻辑通常基于治理运营领域的显性或隐性规则，自上而下进行。这些可能存在于外部系统中，Palantir 可以通过 [外部函数](https://www.palantir.com/docs/foundry/data-integration/external-functions/) 和 [Webhooks](https://www.palantir.com/docs/foundry/data-connection/webhooks-overview/) 直接连接这些系统以在运营工作流中进行实时交互，或通过 [外部变换](https://www.palantir.com/docs/foundry/data-integration/external-transforms/) 进行管道连接。业务逻辑也可以直接在 Palantir 平台内使用 [规则](https://www.palantir.com/docs/foundry/foundry-rules/overview/) 和管道构建器为数据管道中的逻辑进行编写，以及为将在运行时执行的逻辑使用 Automate 和函数。

#### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%A8%A1%E6%9D%BF%E5%8C%96%E5%88%86%E6%9E%90%E5%92%8C%E6%8A%A5%E5%91%8A) 模板化分析和报告

_对象视图、分析模板、生成的报告_

逻辑不仅存在于数据科学模型中或作为硬编码业务规则；分析师通常在一次性调查、分析或报告中捕获和收集高价值逻辑。在 Palantir 平台中，您可以使用 [Contour](https://www.palantir.com/docs/foundry/contour/overview/) 和 [Quiver](https://www.palantir.com/docs/foundry/quiver/overview/) 等点击分析工具以及 [Code Workspaces](https://www.palantir.com/docs/foundry/code-workspaces/overview/) 等笔记本构建分析和仪表盘。Ontology 数据模型的语义使得很容易将这些分析产品模板化并重复使用，无论是嵌入在 [对象视图](https://www.palantir.com/docs/foundry/object-views/config-overview/) 或 [Workshop应用](https://www.palantir.com/docs/foundry/workshop/module-interface/) 中，还是作为独立 [仪表盘](https://www.palantir.com/docs/foundry/notepad/widgets-quiver-dashboard/) 展示。这些对象视图、模板化分析和仪表盘可以插入运营应用中，提供一目了然的见解以指导决策，同时提供进一步临时探索的途径。

总之，这三个逻辑方面——模型、业务逻辑和模板化分析及报告——提供了一个工具箱或调色板，用户可以从中自由组合，为决策者在关键时刻提供所需的所有上下文。

### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%93%8D%E4%BD%9C) 操作

为了使任何决策产生影响，该决策必须传播到世界中。这就是操作定义企业“动词”的地方 \- 也就是所做的事情 \- 并控制人类操作员或 AI 代理如何确保其决策持续存在，无论是在 Ontology 数据模型中还是通过与 [外部系统](https://www.palantir.com/docs/foundry/action-types/side-effects-overview/) 的交互。此外，在 Ontology 中捕获决策结果允许用户将特定决策与未来数据中的结果观察配对。这使得反馈循环成为可能，将未来的决策置于过去选择的背景中，并可以用于重新训练或微调模型，或者仅仅支持操作员更清晰地了解过去。

在 Ontology 中表示这些“动力学”的原子单位是 [操作](https://www.palantir.com/docs/foundry/action-types/overview/)，它提供了特定、细粒度的控制用于更改或创建数据，以及用于在外部系统中协调更改。可以通过一个点击配置界面简单地定义基本操作。可以通过 [函数支持的操作](https://www.palantir.com/docs/foundry/action-types/function-actions-overview/) 和 [Ontology 编辑 TypeScript API](https://www.palantir.com/docs/foundry/functions/api-ontology-edits/) 指定任意复杂的操作。操作也可以在 [Ontology 软件开发工具包](https://www.palantir.com/docs/foundry/ontology-sdk/overview/)（OSDK）和 [平台API](https://www.palantir.com/docs/foundry/api/ontology-resources/actions/action-basics/) 中打包，以便自定义应用开发和现有第三方工具可以轻松且安全地写回到 Ontology。

每个操作的 [权限](https://www.palantir.com/docs/foundry/action-types/permissions/) 确定哪个用户或代理在什么条件下能够执行操作，为安全、可审计和透明的控制奠定了基础。

在复杂、紧密耦合的环境中，如供应链或制造车间，一个小的变化可能会引起级联效应，产生意外或意图之外的结果。 [场景](https://www.palantir.com/docs/foundry/vertex/scenarios-overview/) 原语允许用户通过对 Ontology 的一个分支进行更改来预测这些后果，有效地创建一个沙盒宇宙，在这个宇宙中可以对潜在变化进行预测、业务流程模型和其他分析。 [Vertex](https://www.palantir.com/docs/foundry/vertex/overview/) 应用专门用于这种过程可视化和情景测试； [Workshop](https://www.palantir.com/docs/foundry/workshop/scenarios-overview/) 应用构建器本地支持情景用于开发包含“假如...”工作流的运营应用。

这些原语为安全开发在生产工作流中操作的人类+AI 团队创造了环境。操作的细粒度权限和访问控制提供了一个“控制平面”，其中代理被沙盒化，具有对其可以使用的数据和工具的特定限制。在大多数模式中，AI 代理不是直接进行更改，而是通过与 [集成到 Workshop 的 AIP Logic](https://www.palantir.com/docs/foundry/logic/overview/) 函数的直接集成同步创建提案，或通过 [Automate](https://www.palantir.com/docs/foundry/automate/overview/) 或 [Pipeline Builder 中的 Use LLM](https://www.palantir.com/docs/foundry/pipeline-builder/pipeline-builder-llm/) 节点异步创建提案。生成的提案然后可以呈现给操作员以进行改进、反馈和最终决策。此基于提案的模式，除了加强“人类在回路中”范式外，还生成了有价值的元数据，使代理能够在持续反馈的情况下学习和发展。

## [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%8E%A5%E4%B8%8B%E6%9D%A5%E6%98%AF%E4%BB%80%E4%B9%88) 接下来是什么？

体验 AIP 威力的最佳方式是开始构建。阅读 [入门](https://www.palantir.com/docs/foundry/getting-started/overview/) 指南以获取更多信息，或者 \- 如果您可以访问平台 \- 只需询问 AIP Assist 根据您的目标建议从何处开始。

有关这些决策组件如何交互以指导工作流开发的更多信息，请参阅关于 [提炼功能需求](https://www.palantir.com/docs/foundry/use-case-life-cycle/distilling-functional-requirements/) 的讨论，在 [应用案例开发](https://www.palantir.com/docs/foundry/use-case-life-cycle/overview/) 中讨论，或在 [AIP Now 展示 ↗](https://aip.palantir.com/) 中找到行业特定的端到端工作流示例。

此外，您可能会对了解 AIP 的构建方式以及如何与您组织中的现有投资集成感兴趣：

- [架构](https://www.palantir.com/docs/foundry/platform-overview/architecture/)
- [互操作性](https://www.palantir.com/docs/foundry/platform-overview/interoperability/)
- [开发生命周期](https://www.palantir.com/docs/foundry/platform-overview/development-life-cycle/)

## [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%B9%B3%E5%8F%B0%E8%83%BD%E5%8A%9B) 平台能力

文档的其余部分被组织为 [平台能力](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#platform-capabilities) 的集合。每个能力的摘要如下：

- [数据连接和集成](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#data-connectivity-and-integration)
- [模型连接与开发](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#model-connectivity-and-development)
- [Ontology 构建](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#ontology-building)
- [应用案例开发](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#use-case-development)
- [分析](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#analytics)
- [产品交付](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#product-delivery)
- [安全与治理](https://www.palantir.com/docs/zh/foundry/platform-overview/overview#security-and-governance)

### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%95%B0%E6%8D%AE%E8%BF%9E%E6%8E%A5%E5%92%8C%E9%9B%86%E6%88%90) 数据连接和集成
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E6%A8%A1%E5%9E%8B%E8%BF%9E%E6%8E%A5%E4%B8%8E%E5%BC%80%E5%8F%91) 模型连接与开发
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#ontology-%E6%9E%84%E5%BB%BA) Ontology 构建

如上所述，为了创建一个综合的决策中心企业模型，Ontology 集成了：

- _数据_，作为 [对象和链接](https://www.palantir.com/docs/foundry/ontology/overview/#object-and-link-types)；
- _逻辑_，作为 [模型](https://www.palantir.com/docs/foundry/model-integration/overview/) 和 [函数](https://www.palantir.com/docs/foundry/functions/overview/)；以及
- _操作_，作为平台 [操作](https://www.palantir.com/docs/foundry/action-types/overview/)。
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%BA%94%E7%94%A8%E6%A1%88%E4%BE%8B%E5%BC%80%E5%8F%91) 应用案例开发
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%88%86%E6%9E%90) 分析
...
平台还与常用建模环境（支持使用 [Code Workspaces](https://www.palantir.com/docs/foundry/code-workspaces/overview/) 的 JupyterLab® 和 RStudio® Workbench 的本地使用）和商业智能平台（包括 Tableau® 和 PowerBI® 的 [专用连接器](https://www.palantir.com/docs/foundry/analytics-connectivity/overview/)）互操作。

### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E4%BA%A7%E5%93%81%E4%BA%A4%E4%BB%98) 产品交付
...
### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E5%AE%89%E5%85%A8%E4%B8%8E%E6%B2%BB%E7%90%86) 安全与治理

Palantir 平台具有全面的、最佳实践的安全模型，该模型传播到整个平台，并且默认情况下，与信息同行无论其走向何处。能力包括：

- [所有数据的加密](https://www.palantir.com/docs/foundry/security/overview/#enterprise-security)，无论是在传输中还是在静止时；
- 身份验证和身份保护控制；
- 授权控制可以结合基于角色、权限标记和目的驱动的范式；
- 强大的安全 [审计日志](https://www.palantir.com/docs/foundry/security/audit-logs-overview/)；以及
- 高度可扩展的信息治理、管理和 [隐私控制](https://www.palantir.com/docs/foundry/security/protecting-sensitive-data/)。

### [Copy link to section](https://www.palantir.com/docs/zh/foundry/platform-overview/overview\#%E7%AE%A1%E7%90%86%E4%B8%8E%E6%94%AF%E6%8C%81) 管理与支持

平台管理员可以访问一套强大的工具来管理 Palantir 平台。平台管理的核心应用是：

- [控制面板](https://www.palantir.com/docs/foundry/administration/control-panel/)
- [资源管理](https://www.palantir.com/docs/foundry/resource-management/overview/)
- [升级助手](https://www.palantir.com/docs/foundry/upgrade-assistant/overview/)

平台管理员和项目经理还可以访问促进用户支持的资源，例如 [AIP Assist](https://www.palantir.com/docs/foundry/assist/overview/)。这些资源在 [管理与支持文档](https://www.palantir.com/docs/foundry/administration/overview/) 中进行了描述。

[NEXT架构\\
→](https://www.palantir.com/docs/zh/foundry/platform-overview/architecture/)
