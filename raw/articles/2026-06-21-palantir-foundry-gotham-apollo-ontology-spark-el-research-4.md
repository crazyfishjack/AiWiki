...
| exa | 1.00 | Getting Your Indices in a Row: Full-Text Search for LLM Training Data for Real World | https://arxiv.org/html/2510.09471 |
...
| exa | 1.00 | SALT-KG: A Benchmark for Semantics-Aware Learning on Enterprise Tables | https://arxiv.org/html/2601.07638 |
| exa | 1.00 | From Business Events to Auditable Decisions: Ontology-Governed Graph Simulation for Enterprise AI | https://arxiv.org/pdf/2604.08603 |
...
| exa | 1.00 | Supporting Digital Twin Integration Using Semantic Modeling and High-Level Architecture \| Springer Nature Link | https://link.springer.com/chapter/10.1007/978-3-030-85910-7_24 |
...
| tavily | 0.54 | Palantir Competitors: Understanding Alternatives to Gotham and ... | https://datawalk.com/palantir-competitors-understanding-alternatives-to-gotham-and-foundry |
| tavily | 0.54 | Palantir Operationalizes Analytics and Data for Actions and Decisions | https://research.isg-one.com/analyst-perspectives/palantir-operationalizes-analytics-and-data-for-actions-and-decisions |
...
3. [Data Digitization in Manufacturing Factory Using Palantir Foundry Solution](https://www.mdpi.com/2227-9717/12/12/2816)
   ...
   - 后续处理：进入 rerank
4. [Foundry: a message-oriented, horizontally scalable ETL system for scientific data integration and enhancement](https://pmc.ncbi.nlm.nih.gov/articles/PMC6301337/)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 一手数据
   - 后续处理：进入精读
5. [Getting Your Indices in a Row: Full-Text Search for LLM Training Data for Real World](https://arxiv.org/html/2510.09471)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
6. [Concept-Centric Software Development](https://arxiv.org/html/2304.14975)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
7. [Unifying Ontology Construction and Semantic Alignment for Deterministic Enterprise Reasoning at Scale](https://arxiv.org/html/2604.09608)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
8. [Construct, Align, and Reason: Large Ontology Models for Enterprise Knowledge Management](https://arxiv.org/html/2602.00029)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
9. [OntoKG: Ontology-Oriented Knowledge Graph Construction with Intrinsic-Relational Routing](https://www.arxiv.org/pdf/2604.02618)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
10. [Unifying Ontology Construction and Semantic Alignment for Deterministic Enterprise Reasoning at Scale](https://arxiv.org/abs/2604.09608v1)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
11. [SALT-KG: A Benchmark for Semantics-Aware Learning on Enterprise Tables](https://arxiv.org/html/2601.07638)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
12. [From Business Events to Auditable Decisions: Ontology-Governed Graph Simulation for Enterprise AI](https://arxiv.org/pdf/2604.08603)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
13. [𝖠𝗎𝗍𝗈𝖵𝖾𝗋𝗂𝖿𝗂𝖾𝗋: An Agentic Automated Verification Framework Using Large Language Models](https://arxiv.org/html/2604.02617v1)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
14. [Supporting Digital Twin Integration Using Semantic Modeling and High-Level Architecture | Springer Nature Link](https://link.springer.com/chapter/10.1007/978-3-030-85910-7_24)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：学术论文
   - 后续处理：进入精读
15. [Building Knowledge Graph in Spark Without SPARQL | Springer Nature Link](https://link.springer.com/chapter/10.1007/978-3-030-59028-4_9)
   - 工具：exa
   - 分数：Exa 默认保留
   - 来源等级：A
   - 入库映射：`source-quality: high`
...
19. [[PDF] 相关研究报告北交所研究团队 - i研报](https://file.iyanbao.com/pdf/1f1fc-fd3e408a-98d0-47f5-a93a-a9e7dd6537e9.pdf)
   ...
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
20. [帕兰泰尔- 维基百科，自由的百科全书](https://zh.wikipedia.org/zh-cn/%E5%B8%95%E8%98%AD%E6%B3%B0%E7%88%BE)
   - 工具：tavily
   - 分数：0.69
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
21. [以AI+本体框架整合多源数据，依托4大平台，让Palantir得以发现隐藏 ...](https://www.smartcity.team/investment/companies/palantir)
   - 工具：tavily
   - 分数：0.69
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
22. [万字解读Palantir产品、技术和架构讨论 - 53AI](https://www.53ai.com/news/AISaaS/2025121217384.html)
   - 工具：tavily
   - 分数：0.68
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
23. [[PDF] Palantir— —深挖政府大数据的神秘独角兽](https://file.iyanbao.com/pdf/1913d-99d0e401-e9a1-4d4c-9878-e90824c59ccc.pdf)
   - 工具：tavily
   - 分数：0.68
   - 来源等级：C
   - 入库映射：`source-quality: medium`
...
26. [平台概览 - Palantir](https://www.palantir.com/docs/zh/foundry/platform-overview/overview)
   ...
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
27. [构建管道• Best practices • 推荐的项目和团队结构 - Palantir](https://www.palantir.com/docs/zh/foundry/building-pipelines/recommended-project-structure)
   - 工具：tavily
   - 分数：0.57
   - 来源等级：A
   - 入库映射：`source-quality: high`
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
28. [Palantir Competitors: Understanding Alternatives to Gotham and ...](https://datawalk.com/palantir-competitors-understanding-alternatives-to-gotham-and-foundry)
   - 工具：tavily
   - 分数：0.54
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
29. [Palantir Operationalizes Analytics and Data for Actions and Decisions](https://research.isg-one.com/analyst-perspectives/palantir-operationalizes-analytics-and-data-for-actions-and-decisions)
   - 工具：tavily
   - 分数：0.54
   - 来源等级：C
   - 入库映射：`source-quality: medium`
...
30. [Integrated platforms: AIP, Foundry, and Apollo - Palantir](https://palantir.com/docs/foundry/architecture-center/platforms)
   ...
   - 保留原因：官方文档 / 技术文档
   - 后续处理：进入精读
31. [MLQ.ai | AI for investors](https://mlq.ai/research/palantir-technologies)
   - 工具：tavily
   - 分数：0.52
   - 来源等级：C
   - 入库映射：`source-quality: medium`
...
32. [同样是数据智能企业，中国版Palantir的根本不同在这里！ - 同花顺](https://stock.10jqka.com.cn/20260316/c675323641.shtml)
   ...
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
33. [Is Palantir as good as they say? is it worth our investment - Reddit](https://www.reddit.com/r/dataengineering/comments/15r6k9i/is_palantir_as_good_as_they_say_is_it_worth_our)
   - 工具：tavily
   - 分数：0.46
   - 来源等级：C
   - 入库映射：`source-quality: medium`
   - 保留原因：相关性一般，需交叉验证
   - 后续处理：仅作背景参考
34. [Palantir Platform: Gotham - Digital Marketplace](https://www.applytosupply.digitalmarketplace.service.gov.uk/g-cloud/services/801146272055049)
   - 工具：tavily
   - 分数：0.40
   - 来源等级：C
   - 入库映射：`source-quality: medium`
...
8. [How SpaceX’s float could lift the tide for European space tech - PitchBook](https://pitchbook.com/news/articles/how-spacexs-float-could-lift-the-tide-for-european-space-tech)
   ...
   - 来源等级：C
   - 剔除原因：score 低于 0.4
9. [Art+AI Fuels Innovation & Entrepreneurship: 2026 Next Generation Philanthropy Leadership Program Opens - Alvinology](https://alvinology.com/2026/06/18/artai-fuels-innovation-entrepreneurship-2026-next-generation-philanthropy-leadership-program-opens-recruitment/)
   - 工具：tavily
   - 分数：0.02
   - 来源等级：C
   - 剔除原因：score 低于 0.4
10. [NewCore Emerges from Stealth with $66M to Rebuild Workforce Identity for the Agentic Era - StreetInsider](https://www.streetinsider.com/PRNewswire/NewCore+Emerges+from+Stealth+with+%2466M+to+Rebuild+Workforce+Identity+for+the+Agentic+Era/26644987.html)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
...
14. [Argon & Co: Organisations must rethink operating models to unlock AI and ERP success - Consultancy-me.com](https://www.consultancy-me.com/news/amp/13716/argon-co-organisations-must-rethink-operating-models-to-unlock-ai-and-erp-success)
   ...
   - 来源等级：C
   - 剔除原因：score 低于 0.4
15. [NewCore Emerges from Stealth with $66M to Rebuild Workforce Identity for the Agentic Era - PR Newswire](https://www.prnewswire.com/news-releases/newcore-emerges-from-stealth-with-66m-to-rebuild-workforce-identity-for-the-agentic-era-302799643.html)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
16. [VivaTech 2026: Bernard Arnault and Jeff Bezos see AI as a driver of responsible innovation - fashionunited.in](https://fashionunited.in/news/fairs/vivatech-2026-bernard-arnault-and-jeff-bezos-see-ai-as-a-driver-of-responsible-innovation/2026061954971)
   - 工具：tavily
   - 分数：0.01
   - 来源等级：C
   - 剔除原因：score 低于 0.4
...
21. [平台概览 - Palantir](https://www.palantir.com/docs/zh/foundry/platform-overview/overview)
   ...
   - 来源等级：A
   - 剔除原因：重复 URL，已合并到最高分结果
22. [Palantir Operationalizes Analytics and Data for Actions and Decisions](https://research.isg-one.com/analyst-perspectives/palantir-operationalizes-analytics-and-data-for-actions-and-decisions)
   - 工具：tavily
   - 分数：0.45
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
23. [Integrated platforms: AIP, Foundry, and Apollo - Palantir](https://palantir.com/docs/foundry/architecture-center/platforms)
   - 工具：tavily
   - 分数：0.43
   - 来源等级：A
   - 剔除原因：重复 URL，已合并到最高分结果
24. [Overview • Ontology - Palantir](https://palantir.com/docs/foundry/ontology/overview)
   - 工具：tavily
   - 分数：0.38
   - 来源等级：A
   - 剔除原因：score 低于 0.4
25. [Palantir 核心技术架构深度研究 - Tech Whims | 张晓龙](https://techwhims.com/cn/posts/palantir-core-architecture)
   - 工具：tavily
   - 分数：0.73
   - 来源等级：B
   - 剔除原因：重复 URL，已合并到最高分结果
26. [以AI+本体框架整合多源数据，依托4大平台，让Palantir得以发现隐藏 ...](https://www.smartcity.team/investment/companies/palantir)
   - 工具：tavily
   - 分数：0.67
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
27. [万字解读Palantir产品、技术和架构讨论 - 53AI](https://www.53ai.com/news/AISaaS/2025121217384.html)
   - 工具：tavily
   - 分数：0.68
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
28. [[PDF] 相关研究报告北交所研究团队 - i研报](https://file.iyanbao.com/pdf/1f1fc-fd3e408a-98d0-47f5-a93a-a9e7dd6537e9.pdf)
   ...
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
29. [Palantir产品套件与平台架构- 53AI-AI知识库](https://www.53ai.com/news/Palantir/2025122362370.html)
   - 工具：tavily
   - 分数：0.67
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
30. [[PDF] 深度解析Palantir](https://pdf.dfcfw.com/pdf/H3_AP202501221642435170_1.pdf)
   - 工具：tavily
   - 分数：0.62
   - 来源等级：C
   - 剔除原因：重复 URL，已合并到最高分结果
31. [平台概览 - Palantir](https://www.palantir.com/docs/zh/foundry/platform-overview/overview)
   - 工具：tavily
   - 分数：0.57
   - 来源等级：A
   - 剔除原因：重复 URL，已合并到最高分结果
...
精读失败：HTTPSConnectionPool(host='api.firecrawl.dev', port=443): Max retries exceeded with url: /v2/scrape (Caused by NewConnectionError("HTTPSConnection(host='api.firecrawl.dev', port=443): Failed to establish a new connection: [Errno 111] Connection refused"))
...
### 来源 9: A Brief Analysis of Palantir Gotham: A Collaborative and Interactive Big Data Visualization Analysis Software Based on Dynamic Ontology | IEEE Conference Publication | IEEE Xplore
...
**DOI:** [10.1109/BigDIA63733.2024.10808897](https://doi.org/10.1109/BigDIA63733.2024.10808897)
...
Palantir's big data analytics technology grounded in dynamic ontologies, alongside its collaborative and interactive analysis software supporting distributed geo-environments, has achieved remarkable success across military,defense,security,and commercial sectors,gainingrecognition from users inthe military,military,federalgovernment,andvariousindustriessuchasfinance.Palantirsocial twintoolingramodelingparadigm,involvingdataandmodelsbasedonyoudynamicalontologies,coupledwithitsintuitivewizard-drivenmodelingsoftwaretoolsandscollaborativeresultsdisplaysystemtechnicalarchitecture,andhuman-centeredcollaborativereviewtechniquesforbigdata.Thepaperanalysesummariesomeofthesimplestopmostcomplexfeaturesofthedigitaltwinsmodelingapproach,thewizarddrivenmodelingtoolsofthedistributedgeoenvironmentalapplication,wizard-drivenvisualizationtoolsforbusinessusers,twoimportantfrontendstylesemployedbyGotham’sinteractivevisualizationanalysis,Gothamsupportofdynamicontologytechnology,andmanagementsystemsandvisualizationsolutions.
...
Note:
- The "Sign in to Continue Reading" button is represented as plain text since there is no actual link provided.
- The DOI link includes a query string `?src=document` which might be used for tracking purposes but does not add any semantic meaning beyond being part of the URL.
- The references section is empty in the original HTML content so it is omitted here.
```
